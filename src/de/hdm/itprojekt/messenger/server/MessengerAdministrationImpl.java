...
/**
 * Die Klasse MessengerAdministrationImpl erbt von der Klasse
 * RemoteServiceServlet und implementiert das Interface MessengerAdministration
 */
public class MessengerAdministrationImpl extends RemoteServiceServlet implements
	...
	/**
	 * Initialisierungsmethode. Diese Methode muss f�r jede Instanz von
	 * MessengerAdministrationImpl aufgerufen werden.
	 * 
	 * @throws IllegalArgumentException
	 */
	public void init() throws IllegalArgumentException {
		/*
		 * Ganz wesentlich ist, dass die MessengerAdministration einen
		...
		this.nutzerAbonnementMapper = NutzerAbonnementMapper
				.getNutzerAbonnementMapper();
		this.hashtagAbonnementMapper = HashtagAbonnementMapper
				.getHashtagAbonnementMapper();
	...
	public UnterhaltungMapper getUnterhaltungMapper()
			throws IllegalArgumentException {
		return this.unterhaltungMapper;
	}

	public NutzerAbonnementMapper getNutzerAbonnementMapper()
			throws IllegalArgumentException {
		return this.nutzerAbonnementMapper;
	}

	public HashtagAbonnementMapper getHashtagAbonnementMapper()
			throws IllegalArgumentException {
	 ...
	 * @return
	 */
	public Vector<Hashtag> findHashtagByName(String name)
			throws IllegalArgumentException {
	...
	/**
	 * Methode um einen oder mehrere Nutzer als Empf�nger einer Nachricht
	 * hinzuzuf�gen
	 * 
	 * @param teilnehmer
	 * @return null
	 ...
	 * @return
	 */
	public Unterhaltung teilnehmerHinzufuegenUnterhaltung(int UnterhaltungsID,
			int NutzerID) throws IllegalArgumentException {
		return this.unterhaltungMapper.teilnehmerHinzufuegen(UnterhaltungsID,
				NutzerID);
	}
	 ...
	 * @return
	 */
	public Vector<Nutzer> getNutzerByEmail(String email)
			throws IllegalArgumentException {
	 ...
	 */
	@Override
	public Nachricht erstelleNachricht(Nachricht n)
			throws IllegalArgumentException {
		// TODO Auto-generated method stub
	...
	public void loescheNutzer(Nutzer n) throws IllegalArgumentException {
		...
		Vector<Nachricht> nachricht = this.nachrichtMapper
				.getNachrichtByNutzer(n);
		if (nachricht != null) {
			for (Nachricht na : nachricht)
				this.nachrichtMapper.loeschen(na);
		}

		Vector<NutzerAbonnement> abonnement = this.nutzerAbonnementMapper
				.getAllNutzerAbonnement();
		if (abonnement != null) {
			for (Abonnement a : abonnement)
				this.loescheNutzerAbonnement(a);
		}

		Vector<HashtagAbonnement> hashtagAbonnement = this.hashtagAbonnementMapper
				.getAllHashtagAbonnement();
	 ...
	 */
	@Override
	public Collection<String> getNutzerCollection()
			throws IllegalArgumentException {
	 ...
	 */
	@Override
	public Collection<String> getHashtagCollection()
			throws IllegalArgumentException {
