...
public class AbonnementInfo extends ReportFormular {
	...
	public void onLoad() {
		...
		/**
		 * Anlegen der DialoxBox für einen Nutzer, welcher zum Chat hinzugefügt werden soll
		 */
		...
		nutzerSuchenDialogBox
				.setText("Geben Sie einen Namen, welcher gesucht werden soll!!!");
		...
		/**
		 * SuggestBox, die anschließend dem Panel suchenDialogBox hinzugefügt
		 * wird
		 */
		final SuggestBox nutzerSuchenSuggestBox = new SuggestBox(
				nutzerSuchenOracle);
		...
		hashtagSuchenDialogBox
				.setText("Geben Sie einen Hashtag, welcher gesucht werden soll!!!");
		 ...
		 * wird
		 */
		final SuggestBox hashtagSuchenSuggestBox = new SuggestBox(
				hashtagSuchenOracle);
		 ...
		 * Button, zum abbrechen
		 */
		Button hahstagNichtSuchenButton = new Button("Abbrechen",
				new ClickHandler() {
					public void onClick(ClickEvent event) {
						hashtagSuchenDialogBox.hide();
						// Hier Applikationslogik für löschen des
