...
public class AboVerwaltung extends Formular {
	 ...
	 * 
	 */
	private static final List<Nutzer> TESTNUTZER = Arrays.asList(new Nutzer(
			"Daniel", "Meier", "dm077@hdm-stuttgart.de"), new Nutzer("Chris",
			"Reichardt", "cr076@hdm-stuttgart.de"), new Nutzer("Kim", "Ishola",
			"ki004@hdm-stuttgart.de"));

	/**
	 * 
	 */
	private static final List<Hashtag> TESTHASHTAG = Arrays.asList(new Hashtag(
			"#Daniel"), new Hashtag("#Christian"), new Hashtag("#Kim"));
	...
	public void onLoad() {
		 ...
		 */
		Button nutzerAboLoeschenButton = new Button("Ja, löschen",
				new ClickHandler() {
		 ...
		 */
		Button nutzerAboNichtLoeschenButton = new Button("Nein, nicht löschen",
				new ClickHandler() {
					public void onClick(ClickEvent event) {
						nutzerAboLoeschenDialogBox.hide();
					}
		 ...
		 */
		Button hashtagAboLoeschenButton = new Button("Ja, löschen",
				new ClickHandler() {
					public void onClick(ClickEvent event) {
		 ...
		 */
		Button hashtagAboNichtLoeschenButton = new Button(
		...
		nutzerAboDialogBox
				.setText("Geben Sie einen Namen zum Abonnieren eines Nutzers ein!");
		 ...
		 */
		Button nutzerAbonnierenButton = new Button("Abonnieren",
				new ClickHandler() {
					public void onClick(ClickEvent event) {
						nutzerAboDialogBox.hide();
						// Hier Applikationslogik für Abonnieren des Nutzers
						// einfügen!!!
					}
				});
		 ...
		 */
		Button keinNutzerAbonnierenButton = new Button("Abbrechen",
				new ClickHandler() {
					public void onClick(ClickEvent event) {
						nutzerAboDialogBox.hide();
					}
		...
		hashtagAboDialogBox
				.setText("Geben Sie einen Namen zum Abonnieren eines Hashtags ein!");
		 ...
		 * Button, zum hinzufügen des gewählten Nutzers
		 */
		Button hashtagAbonnierenButton = new Button("Abonnieren",
				new ClickHandler() {
					public void onClick(ClickEvent event) {
		 ...
		 * Button, zum abbrechen
		 */
		Button keinHashtagAbonnierenButton = new Button("Abbrechen",
				new ClickHandler() {
					public void onClick(ClickEvent event) {
						hashtagAboDialogBox.hide();
					}
		...
		final Button NutzerAboLoeschenButton = new Button(
				"Gewähltes Nutzerabo löschen");
		...
		final Button HashtagAboLoeschenButton = new Button(
				"Gewähltes Hashtagabo löschen");
		...
		final CellList<Nutzer> nutzerCellList = new NutzerCellList()
				.erstelleNutzerCellList();
		...
		final CellList<Hashtag> hashtagCellList = new HashtagCellList()
				.erstelleHashtagCellList();
