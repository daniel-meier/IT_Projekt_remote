...
public class HashtagCellList extends Widget {
	...
	public CellList<Hashtag> erstelleHashtagCellList() {
		 ...
		 */
		CellList<Hashtag> hashtagCellList = new CellList<Hashtag>(HashtagCell,
				HashtagKeyProvider);
		 ...
		 */
		final SingleSelectionModel<Hashtag> HashtagSelectionModel = new SingleSelectionModel<Hashtag>(
				HashtagKeyProvider);
		hashtagCellList.setSelectionModel(HashtagSelectionModel);
		HashtagSelectionModel
				.addSelectionChangeHandler(new SelectionChangeEvent.Handler() {
					public void onSelectionChange(SelectionChangeEvent event) {
						// contactForm.setContact(selectionModel.getSelectedObject());
						// Window.alert("Du hast gewählt: " +
						// HashtagSelectionModel.getSelectedObject().getName());
					}
				});
