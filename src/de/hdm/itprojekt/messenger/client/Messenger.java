		...
		loginService.login(GWT.getHostPageBaseURL(),
				new AsyncCallback<LoginInfo>() {
					...
					public void ladeMessenger() {
						 ...
						 * Button
						 */
						final Button nachrichtenButton = new Button(
								"Nachrichten");
						nachrichtenButton
								.setStylePrimaryName("messenger-menubutton");
						 ...
						 * Button
						 */
						final Button aboverwaltungButton = new Button(
								"Aboverwaltung");
						aboverwaltungButton
								.setStylePrimaryName("messenger-menubutton");
						 ...
						 * Button
						 */
						final Button reportGeneratorButton = new Button(
								"Report Generator");
						reportGeneratorButton
								.setStylePrimaryName("messenger-menubutton");
						navPanel.add(reportGeneratorButton);

						// reportGeneratorButton.addClickHandler(new
						// ClickHandler() {
						// public void onClick(ClickEvent event) {
						...
						final Button aktualisierungsButton = new Button(
								"Aktualisieren");
