...
import de.hdm.itprojekt.messenger.shared.*;
...
public class ClientsideSettings extends CommonSettings {
  ...
  private static MessengerAdministrationAsync messenger = null;
   ...
   */
  private static final String LOGGER_NAME = "Messenger Web Client";
   ...
   * @since 28.02.2012
   */
  public static MessengerAdministrationAsync getMessenger() {
    // Gab es bislang noch keine BankAdministration-Instanz, dann...
    if (messenger == null) {
      // Zunächst instantiieren wir BankAdministration
      messenger = GWT.create(MessengerAdministration.class);
    }
