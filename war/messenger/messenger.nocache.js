...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "messenger" because\n';
  ...
  $wnd.__gwt_activeModules['messenger'] = {
 ...
 * "/messenger.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['messenger'].superdevmode = true;

  var expectedSuffix = '/messenger.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + messenger + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:messenger';
  var devModeSessionKey = '__gwtDevModeSession:messenger';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/messenger/messenger.nocache.js';
  ...
  $wnd.__gwt_activeModules['messenger'].canRedirect = true;
  $wnd.__gwt_activeModules['messenger'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/messenger?user.agent=' + ua + '&_callback=' + callback;
